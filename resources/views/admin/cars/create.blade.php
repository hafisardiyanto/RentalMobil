...
<div class="box" style="max-width: 800px;">
    <form action="{{ route('admin.cars.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div style="margin-bottom: 2rem;">
            <label style="display: block; font-weight: 500; font-size: 0.95rem; margin-bottom: 0.5rem; color: var(--text-main);">Unggah Foto Kendaraan</label>
            <div style="border: 2px dashed #CBD5E1; padding: 2rem; border-radius: 8px; text-align: center; background: #F8FAFC; position: relative;">
                <input type="file" name="image" id="imageInput" accept="image/jpeg,image/png,image/jpg" required style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; opacity: 0; cursor: pointer; z-index: 10;">
