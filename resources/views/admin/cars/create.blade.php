...
@section('content')
    <div class="page-header">
        <div>
            <h1 class="page-title m-0">Tambah Armada Baru</h1>
        ...
        <form action="{{ route('admin.cars.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-grid-2">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required placeholder="Cth: Avanza Veloz"
                        class="form-input">
                    @error('name') <span class="error-msg">{{ $message }}</span> @enderror
                </div>
                <div>
                    <label class="form-label">Merek (Brand)</label>
                    <input type="text" name="brand" value="{{ old('brand') }}" required placeholder="Cth: Toyota"
                        class="form-input">
            ...
            <div class="form-grid-4">
                ...
                <div>
                    ...
                    <input type="number" name="year" value="{{ old('year') }}" required min="2000" placeholder="Cth: 2022"
                        class="form-input">
                ...
                <div>
                    ...
                    <input type="number" name="price_per_day" value="{{ old('price_per_day') }}" required
                        placeholder="300000" class="form-input">
